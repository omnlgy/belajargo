...
func main() {
	...
	prices = append(prices, 2.2, 3.3, 22.2)
	fmt.Println(prices)

	dicountPrices := []float64{55.3, 89.0, 22.7}

	prices = append(prices, dicountPrices...)
	fmt.Println(prices)
}
...
// 	fmt.Println("Main hobbies: ", mainHobies)

// 	mainHobies = mainHobies[1:cap(mainHobies)]
// 	fmt.Println("Main hobbies: ", mainHobies)
